          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Expense approval status</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-2xl font-semibold">${formData.amount || "0.00"}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Category</p>
                  <p className="text-sm">{formData.category || "Not selected"}</p>
                </div>
                <div>
